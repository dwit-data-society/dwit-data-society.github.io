...
const Footer = () => {
  return (
    <>
      <footer className="relative flex h-auto w-full flex-col gap-8 overflow-x-hidden px-4 pb-20 pt-10 sm:px-6 md:flex-row md:items-start md:gap-10 xl:h-124 xl:px-0 xl:pb-20 bg-[#070A0E]" id="contact">
          ...
          <div className="flex w-full flex-col gap-8 sm:gap-10 pt-8 pr-0 md:ml-auto md:w-auto md:items-start xl:pr-15 items-center text-center">
              ...
              <div className="inline-flex w-full max-w-92 flex-col items-center text-center">
                ...
                <div className="flex flex-col gap-4 mt-5 text-xl sm:text-2xl md:text-lg lg:text-xl justify-center items-center">
                  <div className="flex flex-row gap-4 items-center">
                    ...
                    <a href="mailto:deerwalkdatasociety@deerwalk.edu.np" className="whitespace-nowrap text-sm sm:text-lg md:text-sm lg:text-base xl:text-base 2xl:text-lg hover:text-[#00c2a8]">
            ...
            <div className="flex w-full justify-center md:justify-start">
              <div className="inline-flex w-full max-w-92 flex-col items-center text-center">
                ...
                <div className="flex flex-row gap-4 mt-5 text-2xl sm:text-3xl md:text-xl lg:text-2xl justify-center items-center">
